...
--Command     : generate_target turing_bombe_wrapper.bd
--Design      : turing_bombe_wrapper
...
entity turing_bombe_wrapper is
  port (
    CLK : in STD_LOGIC;
...
end turing_bombe_wrapper;

architecture STRUCTURE of turing_bombe_wrapper is
  component turing_bombe is
  port (
    CLK : in STD_LOGIC;
    LED_FIRST_STOP_OUT : out STD_LOGIC;
    LED_SECOND_STOP_OUT : out STD_LOGIC;
  ...
  end component turing_bombe;
begin
turing_bombe_i: component turing_bombe
     port map (
      CLK => CLK,
