...
entity turing_bombe_final_wrapper is
  port (
    CLK : in STD_LOGIC;
...
end turing_bombe_final_wrapper;

architecture STRUCTURE of turing_bombe_final_wrapper is
  component turing_bombe_final is
  port (
    CLK : in STD_LOGIC;
    LED_FIRST_STOP_OUT : out STD_LOGIC;
    LED_FOURTH_STOP_OUT : out STD_LOGIC;
  ...
  end component turing_bombe_final;
begin
turing_bombe_final_i: component turing_bombe_final
     port map (
      CLK => CLK,
