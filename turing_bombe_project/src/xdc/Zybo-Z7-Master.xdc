...
##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports LED_FIRST_STOP_OUT]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports LED_SECOND_STOP_OUT]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports LED_THIRD_STOP_OUT]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports LED_FOURTH_STOP_OUT]
...
set_output_delay -clock [get_clocks sys_clk_pin] 8.000 [get_ports -filter { NAME =~  "*" && DIRECTION == "OUT" }]
