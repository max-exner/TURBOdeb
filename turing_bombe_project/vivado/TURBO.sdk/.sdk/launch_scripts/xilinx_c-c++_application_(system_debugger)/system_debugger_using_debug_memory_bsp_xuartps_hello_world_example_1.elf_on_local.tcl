...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo Z7 210351A81DFBA"} -index 0
dow /homes/mexner/TURBOdeb/turing_bombe_project/vivado/TURBO.sdk/memory_bsp_xuartps_hello_world_example_1/Debug/memory_bsp_xuartps_hello_world_example_1.elf
