...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo Z7 210351A81DFBA"} -index 0
dow /homes/tniggemeyer/Development/TURBOdeb/repar_turing_bombe/turing_bombe_project/vivado/TURBO.sdk/TURBOdeb_Communication_V01/Debug/TURBOdeb_Communication_V01.elf
